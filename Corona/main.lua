...
timer.performWithDelay( 500, function()
	...
	infantium.setContentAppUUID("87675d63d9b84682bb4579a709dac7e2")
	infantium.setSubContentUUID("029277974857406984835f7ef0c277cc")
end )

timer.performWithDelay( 2500, function()
	-- Start the Gameplay
	infantium.createGameplay("029277974857406984835f7ef0c277cc")
